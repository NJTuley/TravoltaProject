...
public class MessageFromPractitioner extends Activity {
    ...
    public MessageFromPractitioner()
    {
        sender_id = "NULL";
        content = "NULL";
        image = null;
    ...
    MessageFromPractitioner(String _sender, String _subject, String _content, String _severity, Image _img)
    {
        setId(_sender);
        setSubject(_subject);
        setContent(_content);
